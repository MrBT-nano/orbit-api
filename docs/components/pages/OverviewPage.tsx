...
export default function OverviewPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Callout type="info">
        Orbit is currently in <strong>v1.0.0-SNAPSHOT</strong>. Core user
        management and account functionality are live. Transaction tracking,
        payment processing, and AI insights are on the roadmap.
      </Callout>
