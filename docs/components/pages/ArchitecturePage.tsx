          ...
          <div className="bg-[#2A1F3D]/30 border border-white/6 rounded-2xl p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <span className="text-xs text-[#5DFDCB] font-mono">
                  Primary
                </span>
              </div>
            </div>
            <p className="text-sm text-[#9B8FB8] leading-relaxed">
              ACID-compliant relational database for all financial transactions,
              user accounts, and ledger entries. Managed via Spring Data JPA with
              automatic Docker Compose lifecycle.
            </p>
          </div>
          <div className="bg-[#2A1F3D]/30 border border-white/6 rounded-2xl p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <span className="text-xs text-[#B07AFF] font-mono">
                  Planned
                </span>
              </div>
            </div>
            <p className="text-sm text-[#9B8FB8] leading-relaxed">
              Document store for analytics data, spending insights, and
              time-series financial metrics. Optimized for read-heavy
...
└── exception/        # Module-specific exceptions
    └── FeatureNotFoundException.java`,
      ...
      <Callout type="info">
        ...
        <strong>ledger</strong> feature modules are fully implemented.
        Additional modules (payment, crypto, audit) are on the roadmap.
      </Callout>
