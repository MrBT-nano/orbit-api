...
export default function DevelopSidebar({ locale, mobile }: { locale: string; mobile?: boolean }) {
	...
	const apiSections = [
		...
		},
		{
			...
			basePath: `/${locale}/develop/api/payment-methods`,
			items: [
				{ method: "POST", label: "Add Method", href: `/${locale}/develop/api/payment-methods` },
				{ method: "GET", label: "Get Method", href: `/${locale}/develop/api/payment-methods` },
				{
					method: "GET",
					label: "User Methods",
					href: `/${locale}/develop/api/payment-methods`,
				},
				{ method: "PATCH", label: "Update", href: `/${locale}/develop/api/payment-methods` },
				{
					method: "DELETE",
					label: "Remove",
					href: `/${locale}/develop/api/payment-methods`,
		...
		},
		{
			...
			basePath: `/${locale}/develop/api/subscriptions`,
			items: [
				{ method: "POST", label: "Create", href: `/${locale}/develop/api/subscriptions` },
				{ method: "GET", label: "Get", href: `/${locale}/develop/api/subscriptions` },
				{ method: "GET", label: "User Subs", href: `/${locale}/develop/api/subscriptions` },
				{ method: "PATCH", label: "Update", href: `/${locale}/develop/api/subscriptions` },
				{
					method: "PATCH",
					label: "Pause/Resume",
